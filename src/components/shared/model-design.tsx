...
const ModelDesign = () => {
  ...
  return (
    <div className="container flex flex-col justify-center items-center">
        <h1 className="text-4xl font-black my-3 mb-12 w-1/2 leading-10 text-center pl-8 font-jost">State-of-the-Art AI-Powered Cyber Forensics Engine</h1>
        <div ref={containerRef} className="h-full container flex flex-col md:flex-row overflow-hidden sticky top-0">
