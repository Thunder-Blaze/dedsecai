...
const ForensicsCard: React.FC<ForensicsCardProps> = ({icon, title, desc}) => {
  return (
    <div className='w-full p-1 py-4 md:p-4 md:py-8 bg-blue-900/10 rounded-lg flex flex-col justify-center items-center gap-4'>
      ...
      <h3 className='text-2xl text-center text-accent font-semibold'>{title}</h3>
